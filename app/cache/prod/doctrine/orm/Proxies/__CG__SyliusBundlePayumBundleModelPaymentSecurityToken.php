...
class PaymentSecurityToken extends \Sylius\Bundle\PayumBundle\Model\PaymentSecurityToken implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'details', 'hash', 'afterUrl', 'targetUrl', 'paymentName');
        }
    ...
    public function getPaymentName()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPaymentName', array());

        return parent::getPaymentName();
    }
    ...
    public function setPaymentName($paymentName)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPaymentName', array($paymentName));

        return parent::setPaymentName($paymentName);
    }
