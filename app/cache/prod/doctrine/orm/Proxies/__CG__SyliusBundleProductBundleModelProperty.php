 ...
 */
class Property extends \Sylius\Bundle\ProductBundle\Model\Property implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'type', 'presentation', 'configuration', 'createdAt', 'updatedAt');
        }
