...
namespace Proxies\__CG__\Sylius\Bundle\ProductBundle\Model;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class ProductProperty extends \Sylius\Bundle\ProductBundle\Model\ProductProperty implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'product', 'property', 'value');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductProperty $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setProduct(\Sylius\Bundle\ProductBundle\Model\ProductInterface $product = NULL)
    {
     ...
     * {@inheritDoc}
     */
    public function setProperty(\Sylius\Bundle\ProductBundle\Model\PropertyInterface $property)
    {
