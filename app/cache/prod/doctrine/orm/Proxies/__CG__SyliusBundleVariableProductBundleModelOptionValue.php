 ...
 */
class OptionValue extends \Sylius\Bundle\VariableProductBundle\Model\OptionValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'value', 'option');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OptionValue $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setOption(\Sylius\Bundle\VariableProductBundle\Model\OptionInterface $option = NULL)
    {
