 ...
 */
class Address extends \Sylius\Bundle\AddressingBundle\Model\Address implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'firstName', 'lastName', 'company', 'country', 'province', 'street', 'city', 'postcode', 'createdAt', 'updatedAt');
        }
     ...
     * {@inheritDoc}
     */
    public function isValidProvince(\Symfony\Component\Validator\ExecutionContextInterface $context)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isValidProvince', array($context));

        return parent::isValidProvince($context);
    }
