 ...
 */
class Coupon extends \Sylius\Bundle\PromotionsBundle\Model\Coupon implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'code', 'usageLimit', 'used', 'promotion', 'expiresAt');
        }
