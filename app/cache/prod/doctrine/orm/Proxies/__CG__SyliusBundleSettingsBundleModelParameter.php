...
namespace Proxies\__CG__\Sylius\Bundle\SettingsBundle\Model;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Parameter extends \Sylius\Bundle\SettingsBundle\Model\Parameter implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'namespace', 'name', 'value');
        }
