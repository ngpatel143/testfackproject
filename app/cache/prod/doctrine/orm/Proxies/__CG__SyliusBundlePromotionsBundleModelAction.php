 ...
 */
class Action extends \Sylius\Bundle\PromotionsBundle\Model\Action implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'type', 'configuration', 'promotion');
        }
