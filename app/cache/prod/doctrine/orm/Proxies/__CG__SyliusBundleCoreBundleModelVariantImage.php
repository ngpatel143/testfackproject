 ...
 */
class VariantImage extends \Sylius\Bundle\CoreBundle\Model\VariantImage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'variant', 'id', 'file', 'path', 'createdAt', 'updatedAt');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (VariantImage $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setVariant(\Sylius\Bundle\CoreBundle\Model\VariantInterface $variant = NULL)
    {
