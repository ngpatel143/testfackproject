 ...
 */
class Locale extends \Sylius\Bundle\CoreBundle\Model\Locale implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'code', 'enabled', 'createdAt', 'updatedAt');
        }
