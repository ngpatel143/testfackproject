 ...
 */
class User extends \Sylius\Bundle\CoreBundle\Model\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'amazonId', 'facebookId', 'googleId', 'firstName', 'lastName', 'createdAt', 'updatedAt', 'deletedAt', 'currency', 'orders', 'billingAddress', 'shippingAddress', 'addresses', 'id', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
     ...
     * {@inheritDoc}
     */
    public function addAddress(\Sylius\Bundle\AddressingBundle\Model\AddressInterface $address)
    {
     ...
     * {@inheritDoc}
     */
    public function removeAddress(\Sylius\Bundle\AddressingBundle\Model\AddressInterface $address)
    {
     ...
     * {@inheritDoc}
     */
    public function hasAddress(\Sylius\Bundle\AddressingBundle\Model\AddressInterface $address)
    {
