...
namespace Proxies\__CG__\Sylius\Bundle\MoneyBundle\Model;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class ExchangeRate extends \Sylius\Bundle\MoneyBundle\Model\ExchangeRate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'currency', 'rate', 'createdAt', 'updatedAt');
        }
