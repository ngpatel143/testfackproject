 ...
 */
class SlideshowBlock extends \Symfony\Cmf\Bundle\BlockBundle\Doctrine\Phpcr\SlideshowBlock implements \Doctrine\Common\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'title', 'children', 'id', 'name', 'parentDocument', 'ttl', 'settings', 'createdAt', 'updatedAt', 'publishable', 'publishStartDate', 'publishEndDate', 'locale');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SlideshowBlock $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setChildren(\Doctrine\ODM\PHPCR\ChildrenCollection $children)
    {
     ...
     * {@inheritDoc}
     */
    public function addChild(\Sonata\BlockBundle\Model\BlockInterface $child, $key = NULL)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addChild', array($child, $key));
