 ...
 */
class Route extends \Symfony\Cmf\Bundle\RoutingBundle\Doctrine\Phpcr\Route implements \Doctrine\Common\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'parent', 'name', 'children', 'addTrailingSlash', 'idPrefix', 'id', 'content', 'staticPrefix', 'variablePattern', 'addFormatPattern', 'needRecompile');
        }
    ...
    public function setContent($object)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setContent', array($object));

        return parent::setContent($object);
    }
