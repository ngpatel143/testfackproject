 ...
 */
class RssBlock extends \Symfony\Cmf\Bundle\BlockBundle\Doctrine\Phpcr\RssBlock implements \Doctrine\Common\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RssBlock $proxy) {
