 ...
 */
class ReferenceBlock extends \Symfony\Cmf\Bundle\BlockBundle\Doctrine\Phpcr\ReferenceBlock implements \Doctrine\Common\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Symfony\\Cmf\\Bundle\\BlockBundle\\Doctrine\\Phpcr\\ReferenceBlock' . "\0" . 'referencedBlock', 'id', 'name', 'parentDocument', 'ttl', 'settings', 'createdAt', 'updatedAt', 'publishable', 'publishStartDate', 'publishEndDate', 'locale');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ReferenceBlock $proxy) {
    ...
    public function getReferencedBlock()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getReferencedBlock', array());

        return parent::getReferencedBlock();
    }

    /**
     * {@inheritDoc}
     */
    public function setReferencedBlock(\Sonata\BlockBundle\Model\BlockInterface $referencedBlock)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setReferencedBlock', array($referencedBlock));

        return parent::setReferencedBlock($referencedBlock);
    }
