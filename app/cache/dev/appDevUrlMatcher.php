...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
                    ...
                    if (0 === strpos($pathinfo, '/assets/compiled/backend_pro')) {
                        ...
                        if (0 === strpos($pathinfo, '/assets/compiled/backend_promotion')) {
                            ...
                            if ($pathinfo === '/assets/compiled/backend_promotion.js') {
                                return array (  '_controller' => 'assetic.controller:render',  'name' => 'e3b8808',  'pos' => NULL,  '_format' => 'js',  '_route' => '_assetic_e3b8808',);
                            }
                            ...
                            if (0 === strpos($pathinfo, '/assets/compiled/backend_promotion_')) {
                                ...
                                if ($pathinfo === '/assets/compiled/backend_promotion_jquery.livequery_1.js') {
                                    return array (  '_controller' => 'assetic.controller:render',  'name' => 'e3b8808',  'pos' => 0,  '_format' => 'js',  '_route' => '_assetic_e3b8808_0',);
                                }

                                // _assetic_e3b8808_1
                                if ($pathinfo === '/assets/compiled/backend_promotion_sylius-promotion_2.js') {
                                    return array (  '_controller' => 'assetic.controller:render',  'name' => 'e3b8808',  'pos' => 1,  '_format' => 'js',  '_route' => '_assetic_e3b8808_1',);
                                }
                        ...
                        if (0 === strpos($pathinfo, '/assets/compiled/backend_property')) {
                            ...
                            if ($pathinfo === '/assets/compiled/backend_property.js') {
                                return array (  '_controller' => 'assetic.controller:render',  'name' => 'cebdff7',  'pos' => NULL,  '_format' => 'js',  '_route' => '_assetic_cebdff7',);
                            }

                            // _assetic_cebdff7_0
                            if ($pathinfo === '/assets/compiled/backend_property_sylius-property-choices_1.js') {
                                return array (  '_controller' => 'assetic.controller:render',  'name' => 'cebdff7',  'pos' => 0,  '_format' => 'js',  '_route' => '_assetic_cebdff7_0',);
                            }
        ...
        // ibillmaker_hub_core_homepage
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ibillmaker_hub_core_homepage')), array (  '_controller' => 'Ibillmaker\\Hub\\CoreBundle\\Controller\\DefaultController::indexAction',));
        }
