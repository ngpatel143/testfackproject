...
class UserProvider extends FosUserProvider
{
    ...
    {
        $id = $this->container->get('request')->get("companyUrlId");
        $user = $this->container->get('sylius.repository.user')->findOneBy(array('companyUrlId' => $id,'usernameCanonical' => $username));
